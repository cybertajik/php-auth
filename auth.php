<?php
// Generate a random secret passphrase with numerical length of 25 digits. If you would like to add letters change secret.rand parameters
function generateSecretKey($length = 25){
    $secret = '';
...
class auth {
	...
	// Encrypt secret with PGP public key that was provided by user during sign on, that is stored in the SQL database.
